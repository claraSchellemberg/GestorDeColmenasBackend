...
namespace LogicaDeNegocios.Entidades
{
    public class Notificacion
    {
        ...
        //el observer va a agarrar los objetos creados y penidentes y le envia la notificacion al ususario, le cambio el estado a enviado y genera por ej el wpp
        //el usuario leyo el wpp y lee la notificacion y la misma pasa a estado leido
        //en el front una campanita que avise que hay notificaciones pendientes de leer y al ingresar avisamos al back que fue leida pro el usuario
        public Notificacion() { }
