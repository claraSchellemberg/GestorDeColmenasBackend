...
namespace LogicaDeNegocios.Tests.Entidades
{
    public class UsuarioTests
    {
        ...
        public void Constructor_ConParametrosValidos_CreaSatisfactoriamente()
        {
            ...
            // Act
            var usuario = new Usuario(nombre, email, contraseña, numeroTelefono, numeroApicultor);
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = null, Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = null, Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = null, NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "emailSinArroba.com", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@@example.com", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "pass12", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "pass1", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "+09999123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = null };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "test@domain.co", Contraseña = "contraseña123", NumeroTelefono = "+59899123456" };
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "+59899999999" };
        ...
        {
            // Arrange
            var usuario = new Usuario("Juan", "juan@example.com", "contraseña123", "+59899123456", "AP12345");
        ...
        {
            // Arrange
            var usuario = new Usuario { Nombre = "Juan", Email = "juan@example.com", Contraseña = "contraseña123", NumeroTelefono = "+598 99 123 456" };
